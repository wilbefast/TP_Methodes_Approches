...
\end{table}\\
La variation du temps d'exécution en fonction du nombre d'objets est tracé par la courbe ci-dessous~:
\begin{figure}[h!]
\centering
\begin{tikzpicture}[scale=1.2]
    \begin{axis}[title=Jeux de tests pour Sac à dos, xlabel= nombre d'objets, ylabel= temps d'exécution]
      \addplot
        ...
        \legend{exécution de sac à dos, comparaison}
    \end{axis}
\end{tikzpicture}
...
\end{table}\\
La variation du temps d'exécution en fonction du capacité du sac est tracé par la courbe ci-dessous~:
\begin{figure}[h!]
\centering
\begin{tikzpicture}[scale=1.2]
...
\begin{tikzpicture}[scale=1.2]
    \begin{axis}[title=Jeux de tests pour partition, xlabel= nombre d'objets, ylabel= temps d'exécution]
      \addplot
        ...
        \addplot
        table[col sep=comma]{equ2.csv};
        \legend{exécution de partition, comparaison}
    \end{axis}
\end{tikzpicture}
