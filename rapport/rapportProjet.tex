...
particulier de la syntaxe du langage Gnu MathProg. Pour chaque
problème présenté, un fichier .mod contenant la modélisation du
problème est créé ainsi qu'autant de fichiers .dat que de jeux de test.
...
Ce qui nous donne des fichiers modèles de la forme suivante~:
...
TODO : présenter les résultats

\paragraph{Partition}

\paragraph{Voyageur de commerce}
