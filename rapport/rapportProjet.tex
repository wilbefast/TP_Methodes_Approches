...
Proposition de William avec une écriture matricielle~:
...
\end{equation}
\paragraph{Question 2}
 Dans un programme en nombre réels, on a plutôt$ s_i \in [0,1]$. Nous
...
donc le problème de la couverture de sommets par des arêtes.
